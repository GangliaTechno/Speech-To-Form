    ...
    <div>
      <div className="border-b-4 h-auto pb-4">
        <div className="block sm:flex md:flex xl:flex justify-start max-w-md pl-6 space-x-12 pt-8 ">
          ...
          <select id="massCasualtySelect" className="block appearance-none w-32 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-blue-500">
          ...
          <div className="mb-4">
          <label htmlFor="gender" className="block text-gray-700 text-sm font-bold mb-2 w-64">
            Gender
          </label>
        ...
        <div className=" inline-block sm:flex md:flex xl:flex justify-start max-w-md pl-14 space-x-12 pt-8 ">
          ...
          <div className="mb-4">
          <label htmlFor="maritialStatus" className="block text-gray-700 text-sm font-bold mb-2 w-64">
           Maritial Status
          </label>
          <select id="maritialStatus" className="block appearance-none w-32 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-blue-500">
            <option value="selectoption">Select Option</option>
      ...
      <div className="border-b-4 h-auto pb-4">
        <div className="block sm:flex md:flex xl:flex justify-start max-w-md pl-6 space-x-12 pt-8 ml-9">
          ...
          <div className="mb-4">
          <label htmlFor="nurseSendTo" className="flex text-gray-700 text-sm font-bold mb-2 w-96">
          Nurse: Send To
          </label>
        ...
        <div className=" inline-block sm:flex md:flex xl:flex justify-start max-w-md pl-14 space-x-12 pt-8 ">
          ...
          <div className="mb-4 ">
            <label htmlFor="visitortag" className="flex text-gray-700 text-sm font-bold mb-2 w-96">
              Visitor id tag provided
            </label>
            <select id="visitortag" className="block appearance-none w-32 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-blue-500">
            <option value="selectoption">Select Option</option>
            <option value="yes">Yes</option>
            <option value="no">No</option>
          </select>      
          ...
          <div className="mb-4">
            <label htmlFor='registrationDesk' className="flex text-gray-700 text-sm font-bold mb-2 w-56">
              Register desk activated
            </label>
            <select id="registrationDesk" className="block appearance-none w-32 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:border-blue-500">
            <option value="selectoption">Select Option</option>
            <option value="yes">Yes</option>
            <option value="no">No</option>  
            </select>     
